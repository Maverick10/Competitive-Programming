/*
This code gives TLE. Problem author says in discussion that this problem can definitely be
solved using integers only. As far as I'm concerned, the angle I'm calculating can be anything
not just integer. I want to know if there exists a way to calculate the angle using integers
only.
Complexity O(n*m)
*/
